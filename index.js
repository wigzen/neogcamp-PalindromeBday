...
let bdayInput = document.querySelector("#bday-input");
...
function clickHandler(e) {
  ...
  if (bdayString !== "") {
    ...
    if (!isPalindrome) {
      ...
      if (ctr1 > ctr2) {
        resultDiv.textContent = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days.`;
      } else {
        resultDiv.textContent = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`;
      }
    } else {
